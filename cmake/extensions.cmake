...
macro(zephyr_library)
  zephyr_library_get_current_dir_lib_name(${PROJECT_ROOT} lib_name)
...
# PROJECT_ROOT/drivers/entropy/CMakeLists.txt
...
function(generate_inc_file
  ...
  add_custom_command(
    ...
    COMMAND
    ${PYTHON_EXECUTABLE}
    ${PROJECT_ROOT}/scripts/file2hex.py
...
function(zephyr_linker_sources location)
  ...
  foreach(file IN ITEMS ${L_UNPARSED_ARGUMENTS})
    ...
    file(RELATIVE_PATH relpath ${PROJECT_ROOT}/include ${path})
...
function(check_if_directory_is_writeable dir ok)
  execute_process(
    COMMAND
    ${PYTHON_EXECUTABLE}
    ${PROJECT_ROOT}/scripts/dir_is_writeable.py
    ${dir}
    RESULT_VARIABLE ret
    )
...
function(find_appropriate_cache_directory dir)
  ...
  if(DEFINED user_dir)
    ...
    set(local_dir ${PROJECT_ROOT}/.cache)
  endif()

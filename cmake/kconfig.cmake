...
# Support multiple SOC_ROOT, remove PROJECT_ROOT as that is always sourced.
set(kconfig_soc_root ${SOC_ROOT})
list(REMOVE_ITEM kconfig_soc_root ${PROJECT_ROOT})
set(OPERATION WRITE)
...
# Support multiple shields in BOARD_ROOT, remove PROJECT_ROOT as that is always sourced.
set(kconfig_board_root ${BOARD_ROOT})
list(REMOVE_ITEM kconfig_board_root ${PROJECT_ROOT})
set(OPERATION WRITE)
